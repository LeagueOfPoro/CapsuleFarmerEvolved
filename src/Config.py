...
class Config:
    ...
    def __init__(self, configPath: str) -> None:
        ...
        if self.bestStreams is None:
            print(
                f"[yellow]WARNING: The bestStreamsUrl is not available. Are you sure it's a accessible to the public? Using local file instead.")
            try:
